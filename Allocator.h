...
public : 
    ...
    inline ~ObjectTraits() {};
    template <typename U>
    inline explicit ObjectTraits(const ObjectTraits<U>&) {};

    //    address
    inline T* address(T& r) { return &r; };
    inline T const* address(const T& r) { return &r; };
...
public : 
    ...
    inline ~StandardAllocPolicy() {};
    inline explicit StandardAllocPolicy(const StandardAllocPolicy&) {};
    template <typename U>
    inline explicit StandardAllocPolicy(const StandardAllocPolicy<U>&) {};
